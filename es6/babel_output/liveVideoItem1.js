...
define(function (require) {
    ...
    var LiveVideoItem = React.createClass({ displayName: "LiveVideoItem",
        ...
        render: function render() {
            ...
            if (liveItem.onLinePeople > 0 && CONF.TOGA.liveWithOnlinePeople === true) {
                totalPlayCount = React.createElement("p", { className: "subname" }, "在线人数：", totalPlayCount);
            }
            ...
            return React.createElement("li", { className: "mod-card-img" }, React.createElement(DotAlarm, { top: -5, right: 0 }), React.createElement("a", { onClick: this.handleClick, "data-addon": addOnData, href: liveItem.detailUrl, "data-ui-smartclick": true, className: "img" }, React.createElement(ImageLazy, { src: liveItem.sPicUrl }), React.createElement("span", { className: "count" }, liveItem.sProgramTitle)), React.createElement("div", { className: "info" }, React.createElement("p", { className: "name" }, liveItem.sLiveName), totalPlayCount));
        }
    });
